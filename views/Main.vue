  ...
  <div>
    <el-row class="row-head">
      <el-col :span="24">
        <el-menu
          ...
          <el-submenu index="2">
            <template slot="title">参考案例</template>
            <el-menu-item index="2-1" @click="clickMenu('/exp1')">示例1</el-menu-item>
            <el-menu-item index="2-2" @click="clickMenu('/exp2')">示例2</el-menu-item>
          </el-submenu>
    ...
    <el-row>
      <el-col :span="1">
        ...
        <!-- </el-card> canvasWidth  canvasHeight  width: 100%; height: 100%;-->
        </div>
        
      </el-col>
      <el-col id="elcolcanvas" :span="23">
        <canvas 
          id="canvas" 
          :width="canvasWidth" 
          :height="canvasHeight"
    ...
    width="30%"
    center>
    <span>课 程:  C++程序设计</span><br>
    <span>author:  魏杨 </span><br>
    <span> email :  weiyangoto@foxmail.com </span>
    <br>
    <br>
    <span style="margin-left: 50%;"><img src="../src/assets/medlogo.png"></span>
  </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      canvasHeight: document.body.clientWidth * 9 / 16,
      paint: false,
      mode: 'pen',
      rectPos: {
        x: 0,
